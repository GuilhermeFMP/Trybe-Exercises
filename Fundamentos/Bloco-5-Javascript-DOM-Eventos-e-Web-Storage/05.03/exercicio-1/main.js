...
firstLi.addEventListener('click', upAndDown);
secondLi.addEventListener('click', upAndDown);
thirdLi.addEventListener('click', upAndDown);
...
myWebpage.addEventListener('dblclick', function () {
  window.location.replace('https://www.linkedin.com/in/guilhermempinho/');
})
